          ...
          <div class="flex flex-col items-center gap-2 flex-1 justify-between min-h-0">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 w-full">
              ...
              <div class="bg-base-200/80 backdrop-blur-sm rounded-lg p-3 sm:p-4 flex flex-col items-center shadow-sm border border-base-300/50 overflow-hidden">
                ...
                <div class="font-mono text-sm font-bold text-base-content text-center truncate w-full">{@sale_mensal}</div>
              </div>
              ...
              <div class="bg-base-200/80 backdrop-blur-sm rounded-lg p-3 sm:p-4 flex flex-col items-center shadow-sm border border-base-300/50 overflow-hidden">
                ...
                <div class="font-mono text-sm font-bold text-base-content text-center truncate w-full">{@ticket_medio_mensal}</div>
              </div>
              ...
              <%= if @show_goal_remaining do %>
                ...
                <div class="bg-base-200/80 backdrop-blur-sm rounded-lg p-3 sm:p-4 flex flex-col items-center shadow-sm border border-base-300/50 overflow-hidden">
                  ...
                  <div class="font-mono text-sm font-bold text-base-content text-center truncate w-full">+{@goal_remaining_display}</div>
                  </div>
                <% else %>
                <div class="bg-base-200/80 backdrop-blur-sm rounded-lg p-3 sm:p-4 flex flex-col items-center shadow-sm border border-base-300/50 overflow-hidden">
                  <div class="flex items-center gap-1.5 text-xs sm:text-sm text-base-content mb-1.5">
